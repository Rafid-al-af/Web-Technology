            ...
            <div class="col-3">
                ...
                <div class="list-group" id="list-tab">
                    ...
                    <a class="list-group-item list-group-item-action" href="changePassword.php" >Change password</a>
					 <a class="list-group-item list-group-item-action" href="changePassword.php" >Edit Patient Information</a>
					  <a class="list-group-item list-group-item-action" href="editDoctor.php" >Edit Doctor Information</a>
					   <a class="list-group-item list-group-item-action" href="changePassword.php" >Patient List</a>
					    <a class="list-group-item list-group-item-action" href="changePassword.php" >Doctor List</a>
						 <a class="list-group-item list-group-item-action" href="changePassword.php" >Appoinment List</a>
                </div>
            </div>
            <div class="col-9">
